...
def inquiry(request):
    if request.method == 'POST':
        ...
        if request.user.is_authenticated:
            ...
            if has_contacted:
                messages.error(request, 'You have already made an inquiry about this car. Please wait till we get back to you')
        ...
        send_mail(
            'New Car Inquiry',
            'You have a new car inquiry for the car' + car_title + '. Please login in to your admin panel for more info.',
            'jatic05@gmail.com',
            [admin_email],
            fail_silently=False,)
