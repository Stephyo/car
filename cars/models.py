...
class Car(models.Model):
    ...
    passenagers = models.IntegerField()
...
# Model requirements
# car_title, city, state, color, model, year, condition, 
# price, desciption, car_photo, car_photo_1, car_photo_2, car_photo_3, car_photo_4,
# features, body_style, engine, transmission, interior, miles, doors, passenagers, 
# vin, mileage, fuel_type, no_of_owners
